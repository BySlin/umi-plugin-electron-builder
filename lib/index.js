...
function default_1(api) {
    ...
    config: {
      default: {
        ...
        logProcess: function logProcess(log, type) {
          if (type === 'normal') {
            utils_1.logProcess('Main', log, chalk_1.default.blue);
          } else if (type === 'error') {
            utils_1.logProcess('Main', log, chalk_1.default.red);
          }
        }
      },
  ...
  api.onBuildComplete(function (_a) {
    ...
    if (err == null) {
      var _c = api.config.electronBuilder,
          builderOptions_1 = _c.builderOptions,
          externals_2 = _c.externals;
      ...
      Object.keys(buildPkg_1.dependencies).forEach(function (dependency) {
        if (!externals_2.includes(dependency) || !external_packages_config_1.default.includes(dependency)) {
          delete buildPkg_1.dependencies[dependency];
        }
      });
      externals_2.forEach(function (external) {
        var _a;

        if (!buildPkg_1.dependencies[external]) {
          buildPkg_1.dependencies[external] = (_a = require(path.join(process.cwd(), 'node_modules', external, 'package.json'))) === null || _a === void 0 ? void 0 : _a.version;
        }
      });
      ...
      for (var _i = 0, buildDependencies_1 = buildDependencies; _i < buildDependencies_1.length; _i++) {
        ...
        if (fse.existsSync(depPackageJsonPath)) {
          ...
          buildPkg_1.dependencies[dep] = (_b = require(path.join(process.cwd(), 'node_modules', dep, 'package.json'))) === null || _b === void 0 ? void 0 : _b.version;
        }
      }
