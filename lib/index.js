  ...
  function buildDist() {
    ...
    externals.forEach((external) => {
      ...
      if (!buildPkg.dependencies[external]) {
        buildPkg.dependencies[external] = (_a2 = require(path.join(process.cwd(), "node_modules", external, "package.json"))) == null ? void 0 : _a2.version;
      }
    });
    ...
    require("electron-builder").build(import_utils.lodash.merge({
