...
var execa = _umi.utils.execa,
    yargs = _umi.utils.yargs,
    merge = _umi.utils.lodash.merge;
...
function _default(api) {
  ...
  var electronPackageJson = fse.readJSONSync(require.resolve('electron/package.json'));
  ...
  api.onBuildComplete(function (_ref2) {
    ...
    if (err == null) {
      ...
      child.on('exit', function () {
        ...
        require('electron-builder').build(merge(_objectSpread({
