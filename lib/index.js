...
function default_1(api) {
    ...
    config: {
      default: {
        ...
        logProcess: function logProcess(log, type) {
          if (type === 'normal') {
            (0, utils_1.logProcess)('Main', log, chalk_1.default.blue);
          } else if (type === 'error') {
            (0, utils_1.logProcess)('Main', log, chalk_1.default.red);
          }
        }
      },
  ...
  api.onStart(function () {
    ...
    if (parallelBuild) {
      var index = process.argv.findIndex(function (arg) {
        return arg === 'electron';
      });
      var buildType = process.argv[index - 1];
  ...
  api.onBuildComplete(function (_a) {
    ...
    if (err == null) {
      if (parallelBuild) {
        ...
        (0, compile_1.runBuild)(api).then(function () {
          buildDist();
  ...
  function buildDist() {
    ...
    var _b = api.config.electronBuilder,
        builderOptions = _b.builderOptions,
        externals = _b.externals;
    var absOutputDir = (0, utils_1.getAbsOutputDir)(api);
    var buildPkg = (0, utils_1.getRootPkg)();
    ...
    for (var _i = 0, buildDependencies_1 = buildDependencies; _i < buildDependencies_1.length; _i++) {
      ...
      var depPackageJsonPath = path.join((0, utils_1.getNodeModulesPath)(), dep, 'package.json');

      if (fse.existsSync(depPackageJsonPath)) {
        buildPkg.dependencies[dep] = require(depPackageJsonPath).version;
      } else {
        buildPkg.dependencies[dep] = (_a = require(path.join(process.cwd(), 'node_modules', dep, 'package.json'))) === null || _a === void 0 ? void 0 : _a.version;
      }
    }
  ...
  function copyMainProcess() {
    var mainSrc = (0, utils_1.getMainSrc)(api);
    ...
    var preloadSrc = (0, utils_1.getPreloadSrc)(api);
