...
function default_1(api) {
  ...
  api.onStart(function () {
    ...
    if (parallelBuild) {
      ...
      if (buildType === 'dev') {
        ...
        compile_1.runBuild(api).catch(function (error) {
          console.error(error);
        });
      }
    }
  ...
  function buildDist() {
    ...
    var buildPkg = utils_1.getRootPkg();
    ...
    fse.writeFileSync(absOutputDir + "/bundled/package.json", JSON.stringify(buildPkg, null, 2));
