...
var runDev = function runDev(api) {
  return __awaiter(void 0, void 0, void 0, function () {
    var logProcess, electronPath, spawnProcess, runMain, buildMainDebounced, buildPreloadDebounced, runPreload, watcher;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          logProcess = api.config.electronBuilder.logProcess;
          electronPath = path_1.default.join(utils_1.getNodeModulesPath(), 'electron', 'dist', 'electron.exe');
          spawnProcess = null;
