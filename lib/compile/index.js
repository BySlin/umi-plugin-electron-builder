...
var buildMain = function buildMain(api) {
  ...
  if (buildType === 'webpack') {
    return webpack_1.build(webpack_1.getMainWebpackConfig(api));
  } else {
    return vite_1.build(vite_2.getMainViteConfig(api));
  }
};
  ...
  if (fse.pathExistsSync(utils_1.getPreloadSrc(api))) {
    ...
    if (buildType === 'webpack') {
      for (var inputFileName in preloadEntry) {
        tasks.push(webpack_1.build(webpack_1.getPreloadWebpackConfig(api, inputFileName, preloadEntry[inputFileName])));
      }
    } else {
      for (var inputFileName in preloadEntry) {
        tasks.push(vite_1.build(vite_2.getPreloadViteConfig(api, inputFileName, preloadEntry[inputFileName])));
      }
    }
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          electronPath = require(path_1.default.join(utils_1.getNodeModulesPath(), 'electron'));
          spawnProcess = null;
          runMain = utils_1.debounce(function () {
            ...
            spawnProcess = child_process_1.spawn(String(electronPath), ["--inspect=" + debugPort, path_1.default.join(utils_1.getDevBuildDir(api), 'main.js')]);
          ...
          buildMainDebounced = utils_1.debounce(function () {
            return buildMain(api);
          }, TIMEOUT);
          buildPreloadDebounced = utils_1.debounce(function () {
