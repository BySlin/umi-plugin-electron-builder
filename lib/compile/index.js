...
var buildPreload = function buildPreload(api) {
  ...
  if (fse.pathExistsSync((0, utils_1.getPreloadSrc)(api))) {
    var tasks = [];
...
var runDev = function runDev(api) {
  return __awaiter(void 0, void 0, void 0, function () {
    var _a, logProcess, debugPort, electronPath, spawnProcess, runMain, buildMainDebounced, buildPreloadDebounced, runPreload, watcher;

    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          _a = api.config.electronBuilder, logProcess = _a.logProcess, debugPort = _a.debugPort;
          electronPath = require(path_1.default.join((0, utils_1.getNodeModulesPath)(), 'electron'));
          spawnProcess = null;
          runMain = (0, utils_1.debounce)(function () {
            if (spawnProcess !== null) {
              spawnProcess.kill('SIGKILL');
              spawnProcess = null;
            }

            spawnProcess = (0, child_process_1.spawn)(String(electronPath), ["--inspect=".concat(debugPort), path_1.default.join((0, utils_1.getDevBuildDir)(api), 'main.js')]);
            spawnProcess.stdout.on('data', function (data) {
              var log = (0, utils_1.filterText)(data.toString());
          ...
          buildMainDebounced = (0, utils_1.debounce)(function () {
            return buildMain(api);
          }, TIMEOUT);
          buildPreloadDebounced = (0, utils_1.debounce)(function () {
            return buildPreload(api);
          }, TIMEOUT);
          runPreload = (0, utils_1.debounce)(function () {
        ...
        case 1:
          ...
          watcher = chokidar.watch(["".concat((0, utils_1.getMainSrc)(api), "/**"), "".concat((0, utils_1.getPreloadSrc)(api), "/**"), "".concat((0, utils_1.getDevBuildDir)(api), "/**")], {
            ignoreInitial: true
          });
          watcher.on('unlink', function (path) {
            if (spawnProcess !== null && path.includes((0, utils_1.getDevBuildDir)(api))) {
              spawnProcess.kill('SIGINT');
              spawnProcess = null;
            }
          }).on('add', function (path) {
            if (path.includes((0, utils_1.getDevBuildDir)(api))) {
              return runMain();
            }
            ...
            if (path.includes((0, utils_1.getMainSrc)(api))) {
            ...
            if (path.includes((0, utils_1.getPreloadSrc)(api))) {
