...
exports.logProcess = exports.logError = exports.logProcessErrorOutput = exports.getAbsOutputDir = exports.getBuildDir = exports.getDevBuildDir = exports.getPreloadSrc = exports.getMainSrc = exports.getNodeModulesPath = exports.getRootPkg = exports.installRely = void 0;
...
function getMainSrc(api) {
  ...
  return vite_1.normalizePath(path_1.default.join(process.cwd(), mainSrc));
}
...
function getPreloadSrc(api) {
  ...
  return vite_1.normalizePath(path_1.default.join(process.cwd(), preloadSrc));
}

exports.getPreloadSrc = getPreloadSrc;

function getDevBuildDir(api) {
  return vite_1.normalizePath(path_1.default.join(api.paths.absTmpPath, 'electron'));
}

exports.getDevBuildDir = getDevBuildDir;

function getBuildDir(api) {
  return vite_1.normalizePath(path_1.default.join(getAbsOutputDir(api), 'bundled'));
}
